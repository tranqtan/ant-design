"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[5946],{65946:function(B,g,l){l.r(g);var w=l(168400),c=l.n(w),y=l(97857),P=l.n(y),p=l(667294),s=l(387350),h=l(647759),M=l(385956),_=l(785893),m,v,x,b,E;s.ZP.registerNode("behavior-start-node",{draw:function(e,n){var d=s.ZP.Util.getTextSize(e.label,16)[0],r=[d+20*2,48],t=n.addShape("rect",{name:"start-node",attrs:{width:r[0],height:r[1],y:-r[1]/2,radius:8,fill:"#fff"}});return n.addShape("text",{attrs:{text:"".concat(e.label),fill:"rgba(0, 0, 0, 0.88)",fontSize:16,fontWeight:500,x:20,textBaseline:"middle"},name:"start-node-text"}),t},getAnchorPoints:function(){return[[0,.5],[1,.5]]}}),s.ZP.registerNode("behavior-sub-node",{draw:function(e,n){var d=s.ZP.Util.getTextSize(e.label,14)[0],r=16,t=[d+16*2+(e.targetType?12:0)+(e.link?20:0),40],o=n.addShape("rect",{name:"sub-node",attrs:{width:t[0],height:t[1],y:-t[1]/2,radius:8,fill:"#fff",cursor:"pointer"}});if(n.addShape("text",{attrs:{text:"".concat(e.label),x:e.targetType?28:r,fill:"rgba(0, 0, 0, 0.88)",fontSize:14,textBaseline:"middle",cursor:"pointer"},name:"sub-node-text"}),e.targetType&&n.addShape("rect",{name:"sub-node-type",attrs:{width:8,height:8,radius:4,y:-4,x:12,fill:e.targetType==="mvp"?"#1677ff":"#A0A0A0",cursor:"pointer"}}),e.children){var a=e.children,i=a.length;n.addShape("rect",{name:"sub-node-children-length",attrs:{width:20,height:20,radius:10,y:-10,x:t[0]-4,fill:"#404040",cursor:"pointer"}}),n.addShape("text",{name:"sub-node-children-length-text",attrs:{text:"".concat(i),x:t[0]+6-s.ZP.Util.getTextSize("".concat(i),12)[0]/2,textBaseline:"middle",fill:"#fff",fontSize:12,cursor:"pointer"}})}return e.link&&n.addShape("dom",{attrs:{width:16,height:16,x:t[0]-12-16,y:-8,cursor:"pointer",html:`
          ...
          `}}}}},"rect");var D=function(e){var n=function d(r){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:0,o=P()({},r);switch(t){case 0:o.type="behavior-start-node";break;case 1:o.type="behavior-sub-node",o.collapsed=!0;break;default:o.type="behavior-sub-node";break}return r.children&&(o.children=r.children.map(function(a){return d(a,t+1)})),o};return n(e)},S=(0,h.kc)(function(u){var e=u.token;return{container:(0,h.iv)(m||(m=c()([`
    width: 100%;
    height: 600px;
    ...
    overflow: hidden;
    position: relative;
  `])),e.borderRadiusLG),title:(0,h.iv)(v||(v=c()([`
    position: absolute;
    top: 20px;
    left: 20px;
    font-size: `,`px;
  `])),e.fontSizeLG),tips:(0,h.iv)(x||(x=c()([`
    display: flex;
    position: absolute;
    bottom: 20px;
    right: 20px;
  ...
  `])),e.marginMD,e.marginXS),extension:(0,h.iv)(E||(E=c()([`
    display: flex;
    align-items: center;
    &::before {
      display: block;
  ...
  `])),e.marginXS)}}),k=function(e){var n=e.data,d=(0,p.useRef)(null),r=S(),t=r.styles,o=(0,M.useRouteMeta)();return(0,p.useEffect)(function(){var a=new s.ZP.TreeGraph({container:d.current,width:d.current.scrollWidth,height:d.current.scrollHeight,renderer:"svg",modes:{default:["collapse-expand","drag-canvas"]},defaultEdge:{type:"cubic-horizontal",style:{lineWidth:1,stroke:"#BFBFBF"}},layout:{type:"mindmap",direction:"LR",getHeight:function(){return 48},getWidth:function(f){return s.ZP.Util.getTextSize(f.label,16)[0]+40},getVGap:function(){return 10},getHGap:function(){return 60},getSide:function(f){return f.data.direction}}});a.on("node:mouseenter",function(i){a.setItemState(i.item,"hover",!0)}),a.on("node:mouseleave",function(i){a.setItemState(i.item,"hover",!1)}),a.on("node:click",function(i){var f=i.item.getModel(),C=f.link;C&&(window.location.hash=C)}),a.data(D(n)),a.render(),a.fitCenter()},[]),(0,_.jsxs)("div",{ref:d,className:t.container,children:[(0,_.jsx)("div",{className:t.title,children:"".concat(o.frontmatter.title," \u884C\u4E3A\u6A21\u5F0F\u5730\u56FE")}),(0,_.jsxs)("div",{className:t.tips,children:[(0,_.jsx)("div",{className:t.mvp,children:"MVP \u884C\u4E3A\u76EE\u7684"}),(0,_.jsx)("div",{className:t.extension,children:"\u62D3\u5C55\u884C\u4E3A\u76EE\u7684"})]})]})};g.default=k}}]);
